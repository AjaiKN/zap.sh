...
#+end_src
*** Manual
- Copy or symlink =bin/zap= into a directory on your PATH.
- To install zsh completions /(optional)/: copy =completions/zsh/_zap= into your zsh completions directory, or source =zap.plugin.zsh=.
** Usage
#+begin_src
